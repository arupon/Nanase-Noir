...
#include "Assets/nHaruka/PCSS4VRC/PCSSLogic/UnityShadowLibrary_mod.cginc"
...
half UnityComputeForwardShadows(float2 lightmapUV, float3 worldPos, float4 screenPos)
{
    ...
    if (realtimeToBakedShadowFade < (1.0f - 1e-2f))
    {
        ...
        //spot realtime shadow
            ...
            float random = ValueNoise(mul(unity_WorldToShadow[0], unityShadowCoord4(worldPos, 1)));
            ...
            #endif
            realtimeShadowAttenuation = UnitySampleShadowmap(spotShadowCoord, random);
        #endif
